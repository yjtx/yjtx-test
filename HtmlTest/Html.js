var examples = {
    "list": ["timer", "soundTestAudio", "soundTestBlob", "soundTestBin", "soundTest", "input", "input2", "textarea", "trans", "userAgent", "client", "save", "sound", "webAudio", "effect", "select", "image", "imageD", "canvasImage", "video"],
