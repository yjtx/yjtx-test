...
var TextFieldInputText = (function (_super) {
    ...
    var __egretProto__ = TextFieldInputText.prototype;
    __egretProto__.initRoot = function () {
        ...
        textField1.addEventListener(egret.Event.CHANGE, function (e) {
            console.log(e.type + "   " + textField1.text);
        }, this);
        ...
        textField2.addEventListener(egret.Event.CHANGE, function (e) {
            console.log(e.type + "   " + textField2.text);
        }, this);
...
TextFieldInputText.prototype.__class__ = "TextFieldInputText";
