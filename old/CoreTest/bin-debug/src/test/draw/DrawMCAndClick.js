...
var DrawMCAndClick = (function (_super) {
    ...
    var __egretProto__ = DrawMCAndClick.prototype;
    ...
    __egretProto__.manMove = function () {
    ...
    __egretProto__.show = function (e) {
        console.log("ff", e.type, e.target);
    };
    __egretProto__.touchend = function (e) {
    ...
    __egretProto__.releaseout = function (e) {
        console.log("releaseout");
        this.mc.gotoAndStop(this.mc.currentLabel);
    };
    __egretProto__.onLoopComplete = function (e) {
        //this.mc.gotoAndStop(this.mc.currentLabel);
        //this.manMove();
    };
...
DrawMCAndClick.prototype.__class__ = "DrawMCAndClick";
