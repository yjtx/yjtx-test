 ...
 */
var GraphicsGuagualeWithRenderTexture = (function (_super) {
    __extends(GraphicsGuagualeWithRenderTexture, _super);
    function GraphicsGuagualeWithRenderTexture() {
        _super.call(this);
        this.y = 300;
    }
    var d = __define,c=GraphicsGuagualeWithRenderTexture,p=c.prototype;
    p.initRoot = function () {
        var w = 300;
        var h = 100;
    ...
    p.onTouchEventHandler = function (e) {
        switch (e.type) {
            case "touchBegin":
                if (this.bg_container.hasEventListener(egret.TouchEvent.TOUCH_MOVE)) {
                    return;
                }
                ...
                this.bg_container.stage.addEventListener(egret.TouchEvent.TOUCH_END, this.onTouchEventHandler, this);
                break;
            case "touchMove":
            ...
            case "touchEnd":
                ...
                this.bg_container.stage.removeEventListener(egret.TouchEvent.TOUCH_END, this.onTouchEventHandler, this);
                break;
        }
    };
    return GraphicsGuagualeWithRenderTexture;
}(EntryDisplayObjectContainer));
egret.registerClass(GraphicsGuagualeWithRenderTexture,'GraphicsGuagualeWithRenderTexture');
