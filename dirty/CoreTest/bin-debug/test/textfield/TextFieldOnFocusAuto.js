 ...
 */
var TextFieldOnFocusAuto = (function (_super) {
    __extends(TextFieldOnFocusAuto, _super);
    function TextFieldOnFocusAuto() {
        _super.call(this);
    }
    var d = __define,c=TextFieldOnFocusAuto,p=c.prototype;
    p.initRoot = function () {
    ...
    return TextFieldOnFocusAuto;
}(EntryDisplayObjectContainer));
egret.registerClass(TextFieldOnFocusAuto,'TextFieldOnFocusAuto');
