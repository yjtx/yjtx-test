var examples = {
    ...
    "Empty": ["HelloWorld"],
    "Event": ["StageADDAndREMOVE", "StageRESIZE", "BoyAndGirl"],

    "Function": ["Super", "DefaultValue", "RegExp1"],
    "Graphics": ["DrawEllipse", "LinesDiff", "CurveTo","LineTest", "Guaguale", "Guaguale2", "DrawArc", "DrawLineClick", "DrawArcFill", "DrawArcRun", "LineStyle", "SomeCircles", "WithoutEndFill", "DrawLine", "ArcCircleRun", "DrawCurve"],
