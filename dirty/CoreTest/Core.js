var examples = {
    ...
    "Graphics": ["DrawRoundRect", "ArcCircleDiff", "DrawEllipse", "LinesDiff", "CurveTo","LineTest", "Guaguale", "Guaguale2", "DrawArc", "DrawLineClick", "DrawArcFill", "DrawArcRun", "LineStyle", "SomeCircles", "WithoutEndFill", "DrawLine", "ArcCircleRun", "DrawCurve"],

    "Loader": ["BinFile", "Bitmap", "Sound", "Text", "PostData", "GetData", "HttpReqeust", "HttpReqeustGet"],
    "Mask": ["MaskGraphics", "ProgressCircle", "MaskRect", "ScrollRect", "DisplayObject", "CircleGraphics", "ArcCircleRun", "WithShapeMove"],
    ...
    "RES": ["LoadAndDispose", "LoadTwoAndDisposeFirst", "ByUrl", "Async", "DisposeAfterUrl", "DisposeAfterAsync", "DisposeAfterRenderTexture", "RenderTextureDouble", "Loaded", "Sheet",
