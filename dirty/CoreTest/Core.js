var examples = {
    ...
    "Graphics": ["LineTest", "DrawArc", "DrawLineClick", "DrawArcFill", "DrawArcRun", "LineStyle", "SomeCircles", "WithoutEndFill", "DrawLine", "ArcCircleRun", "DrawCurve"],
    ...
    "Orientation": ["Normal"],
    "RenderTexture": ["Less257", "CopyGrids", "DrawTwo", "BgTween", "RectSize", "Circle", "SpriteWithBitmap"],
