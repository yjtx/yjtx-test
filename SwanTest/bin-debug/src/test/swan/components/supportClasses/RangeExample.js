...
var RangeViewer = (function (_super) {
    ...
    function RangeViewer() {
        _super.call(this);
        this.skinName = "<s:Skin class=\"skins.RangeViewerSkin\" minWidth=\"30\" minHeight=\"18\" xmlns:s=\"http://ns.egret.com/swan\">\n\t        <s:Image x=\"0\" y=\"0\" source=\"resource/examples/range-background.png\"/>\n\t        <s:Image id=\"pointer\" x=\"60\" y=\"60\" source=\"resource/examples/pointer.png\"/>\n        </s:Skin>";
    }
    var __egretProto__ = RangeViewer.prototype;
...
RangeViewer.prototype.__class__ = "RangeViewer";
...
var RangeExample = (function (_super) {
    ...
    var __egretProto__ = RangeExample.prototype;
    return RangeExample;
})(swan.Group);
RangeExample.prototype.__class__ = "RangeExample";
